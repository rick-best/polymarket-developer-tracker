...
`blocker:agent` is the safe automation loop. It refreshes dry-run reports, site evidence, the Market Intelligence page, and a blocker register without live email, trading, wallet signing, account changes, public posts, or deployment actions. See `docs/blocker-agent.md`.
